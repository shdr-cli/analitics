...
<p align="center">
  ...
  <a href="#-полезные-команды">Команды</a> •
  <a href="#-будущие-планы-проекта">Будущие планы проекта</a> •
</p>
...
|**Обработка ссылок в едином файле**|Ссылки YouTube, TikTok, Instagram вынесе в отдельные файлы, что неудобно в использовании|`0%`|